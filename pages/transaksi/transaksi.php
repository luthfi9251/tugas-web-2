...
function simpanTransaksi()
{
    ...
    if (isset($_SESSION['keranjang'])) {
        foreach ($_SESSION['keranjang'] as $item) {
            ...
            $jumlah = $item['jumlah'];
            $harga = $item['harga'];
            $diskon = 0; // Tambahkan logika untuk menghitung diskon jika diperlukan
            $subtotalHarga = ($harga - $diskon) * $jumlah;
...
function hitungTotalHarga()
{
    ...
    if (isset($_SESSION['keranjang'])) {
        foreach ($_SESSION['keranjang'] as $item) {
            $subtotal = ($item['harga'] - ($item['harga'] * $item["diskon"] / 100)) * $item['jumlah'];
            $totalHarga += $subtotal;
        }
    }
